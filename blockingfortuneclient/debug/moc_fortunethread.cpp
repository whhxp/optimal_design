...
void FortuneThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FortuneThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FortuneThread::newFortune)) {
                *result = 0;
            }
        }
        {
            typedef void (FortuneThread::*_t)(int , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FortuneThread::error)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject FortuneThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_FortuneThread.data,
      qt_meta_data_FortuneThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
