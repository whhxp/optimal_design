...
Set args = WScript.Arguments
	If args.Count = 1 Then
       setting_filename= WScript.Arguments(0)
	end if
'=====================================================================
...
oProject.SaveAs "C:\Users\huihuanwu\Documents\Ansoft\Project1.mxwl", true
...
oModule.CreateReport "Torque", "Transient", "Rectangular Plot",  _
  ...
  "Moving1.LoadTorque", "Moving1.Torque")), Array()
oModule.CreateReport "XY Plot 1", "Transient", "Rectangular Plot",  _
  ...
  "Nominal")), Array("X Component:=", "Time", "Y Component:=", Array( _
  "FluxLinkage(Phase_A)", "FluxLinkage(Phase_B)", "FluxLinkage(Phase_C)")), Array()
oModule.CreateReport "XY Plot 2", "Transient", "Rectangular Plot",  _
  "Setup1 : Transient", Array("Domain:=", "Sweep"), Array("Time:=", Array("All"), "Poles:=", Array( _
  "Nominal"), "Speed_rpm:=", Array("Nominal"), "Thet_deg:=", Array("Nominal"), "Imax:=", Array( _
  "Nominal")), Array("X Component:=", "Time", "Y Component:=", Array( _
  "InducedVoltage(Phase_A)", "InducedVoltage(Phase_B)", "InducedVoltage(Phase_C)")), Array()
...
oModule.ExportToFile "XY Plot 1",  _
  "./reprot_1/pluxlinkage.csv"
oModule.ExportToFile "XY Plot 2",  _
  "./reprot_1/inducedVoltage.csv"
oModule.ExportToFile "XY Plot 3",  _
  "./reprot_1/coreloss.csv"