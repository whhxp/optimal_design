...
/* Performs the necessary initialization to start in state 0. */
{
    ...
    sprintf(varfile, "%svar.txt", filenamebase);
    sprintf(selfile, "%ssel.txt", filenamebase);
    sprintf(cfgfile, "%scfg.txt", filenamebase);
    sprintf(inifile, "%sini.txt", filenamebase);
    sprintf(arcfile, "%sarc.txt", filenamebase);
